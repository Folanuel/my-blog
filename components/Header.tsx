...
function Header() {
    return (
        <header className='backdrop-blur-sm bg-white/30 text-white flex items-center justify-between space-x-2 font-bold my-6 mx-5 md:mx-96 md:my-12 md:px-10 py-2 border border-lg border-white rounded-xl fixed top-0 z-[100]'>
            ...
            <div className='space-x-3 flex pl-5'>
